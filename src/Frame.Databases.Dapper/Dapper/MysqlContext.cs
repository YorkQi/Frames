...
using Frame.Databases.Dapper.DataObjects;
using Frame.Databases.DBContexts;
using Frame.Databases.Entitys;
using Frame.Databases.Entitys.Dtos;
using System;
...
namespace Frame.Databases.Dapper.Dapper
{
    public partial class MysqlContext : IDBContext
    {
        ...
        {
            var dataTable = DataObjectExtensions.ToTable(entity);
            ...
            return QuerySingleOrDefaultAsync<int>(DataObjectMysqlCommand.InsertToSql(dataTable), param);
        }

        public Task<int> InsertBatch<TEntity>(IEnumerable<TEntity> entitys) where TEntity : IEntity
        {
            var dataTables = DataObjectExtensions.ToTable(entitys);
            ...
            return ExecuteAsync(DataObjectMysqlCommand.InsertBatchToSql(dataTables), param);
        }
        ...
        public Task<int> Update<TEntity>(TEntity entity) where TEntity : IEntity
        {
            ...
            return ExecuteAsync(DataObjectMysqlCommand.UpdateToSql(dataTable), param);
        }
        ...
        public Task<int> UpdateBatch<TEntity>(IEnumerable<TEntity> entitys) where TEntity : IEntity
        {
            ...
            return ExecuteAsync(DataObjectMysqlCommand.UpdateBatchToSql(dataTables), param);
        }
